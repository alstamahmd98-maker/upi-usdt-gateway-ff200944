  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--darker-blue))]">
      ...
      <main>
            ...
            <div className="max-w-4xl">
              ...
              <div className="inline-block bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 mb-8">
                <div className="text-center">
                  ...
                  <p className="font-heading text-3xl md:text-4xl font-bold text-white">
                    1 USDT ≈ <span className="text-cta-blue">105 - 110</span> INR
                  </p>
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                {[
                  ...
                  <span
                    key={index}
                    className="px-4 py-2 bg-cta-blue/20 text-cta-blue rounded-full text-sm font-medium border border-cta-blue/30"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  <div className="w-14 h-14 rounded-lg bg-cta-blue/20 flex items-center justify-center mb-5">
          ...
          <div className="container mx-auto px-4">
                ...
                >
                  ...
                  <div className="space-y-3">
                    <a
                      ...
                      className="flex items-center gap-3 text-white hover:text-cta-blue transition-colors"
                    >
            ...
            <div className="mt-12 text-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 bg-cta-blue text-white rounded-lg font-semibold hover:opacity-90 transition-all transform hover:-translate-y-1"
              >
                <MessageCircle className="w-5 h-5" />
                t.me/NDpay888
        ...
        {/* CTA Section */}
        <section className="py-16 bg-cta-blue">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-cta-blue rounded-lg font-semibold hover:bg-white/90 transition-all transform hover:-translate-y-1"
              >
                Contact on Telegram
                <ArrowRight className="w-5 h-5" />
              </a>
