      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            ...
            >
              {/* Number Badge */}
              <div className="absolute -top-3 left-6 px-3 py-1 bg-cta-orange text-white text-xs font-bold rounded">
                / {feature.number}
              </div>

              {/* Icon */}
              <div className="w-16 h-16 rounded-full bg-cta-orange/10 flex items-center justify-center mb-5 group-hover:bg-cta-orange group-hover:scale-110 transition-all">
                <feature.icon className="w-7 h-7 text-cta-orange group-hover:text-white transition-colors" />
              </div>
              ...
              {/* Bottom accent */}
              <div className="absolute bottom-0 left-0 right-0 h-1 bg-cta-orange rounded-b-xl opacity-0 group-hover:opacity-100 transition-opacity" />
            </div>
          ))}
        </div>
      </div>
