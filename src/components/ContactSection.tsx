          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <p className="font-heading font-bold text-foreground group-hover:text-cta-orange transition-colors">
                    Telegram
                  </p>
                  <p className="text-muted-foreground">@DJI149</p>
                </div>
                <ArrowRight className="w-5 h-5 text-muted-foreground ml-auto group-hover:text-cta-orange transition-colors" />
              </a>
            ...
            <form className="space-y-5">
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-cta-orange/20 focus:border-cta-orange transition-colors"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-cta-orange/20 focus:border-cta-orange transition-colors resize-none"
                />
              </div>
              <button
                type="submit"
                className="w-full py-3 bg-cta-orange text-white rounded-lg font-semibold hover:opacity-90 transition-colors"
              >
                Send Message
              </button>
            </form>
