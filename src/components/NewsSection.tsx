            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 bg-cta-blue text-white text-xs font-medium rounded">
                    {item.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <h3 className="font-heading font-bold text-lg text-foreground mb-3 line-clamp-2 group-hover:text-cta-blue transition-colors">
                  {item.title}
                </h3>
                ...
                <a 
                  href="#"
                  className="inline-flex items-center gap-1 text-cta-blue font-medium text-sm hover:underline"
                >
                  Read more
